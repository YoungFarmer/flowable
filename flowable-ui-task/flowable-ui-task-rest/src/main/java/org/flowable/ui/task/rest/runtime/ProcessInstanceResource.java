...
public class ProcessInstanceResource {
    ...
    @GetMapping(value = "/rest/process-instance/{processInstanceId}/Operation",produces = "application/json")
    public ProcessInstanceOperationRepresentation getProcessInstanceOperation(@PathVariable String processInstanceId, HttpServletResponse response){

        return processInstanceService.getProcessInstanceOperation(processInstanceId,response);
