...
public class TaskResource {
    ...
    @GetMapping(value = "/rest/tasks/{taskId}/Operation", produces = "application/json")
    public TaskOperationRepresentation getTaskOperation(@PathVariable String taskId  ) {
        return taskService.getTaskOperation(taskId);
    }
