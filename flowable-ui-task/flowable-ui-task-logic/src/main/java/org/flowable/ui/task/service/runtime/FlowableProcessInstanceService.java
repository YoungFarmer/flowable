...
//import org.flowable.ui.task.application.dao.ProcessInstanceOperationRepository;
//import org.flowable.ui.task.application.dao.ServiceOpRepository;
...
import org.flowable.ui.task.model.runtime.ProcessInstanceOperationRepresentation;
...
//    @Autowired
//    protected ServiceOpRepository serviceOpRepository;
//    @Autowired
//    protected ProcessInstanceOperationRepository processInstanceOperationRepository;
    ...
    public ProcessInstanceRepresentation getProcessInstance(String processInstanceId, HttpServletResponse response) {
        ...
        //开始
//        ProcessInstanceOperation proLog = new ProcessInstanceOperation();
//        System.out.println("结束时间是"+processInstanceResult.getEnded());
//        System.out.println("结束时间是"+String.valueOf(processInstanceResult.getEnded()));
//        if(processInstanceResult.getEnded()!=null) {
//            proLog.setPlanID(processInstanceResult.getProcessDefinitionId());
//            proLog.setInstanceID(processInstanceId);
//            proLog.setPlan_start_time(processInstanceResult.getStarted());
//            proLog.setPlan_end_time(processInstanceResult.getEnded());
//            if(String.valueOf(processInstance)!=null){
//                proLog.setPlan_is_success(1);
//                proLog.setResultInfo("成功");
//            }else{
//                proLog.setPlan_is_success(0);
//                proLog.setResultInfo("失败");
//            }
//            processInstanceOperationRepository.save(proLog);
//        }else{
//            System.out.println("流程实例还没有结束");
//        }
    ...
    public ProcessInstanceOperationRepresentation getProcessInstanceOperation(String processInstanceId, HttpServletResponse response){
        ...
        ProcessInstanceOperationRepresentation processInstanceResult = new ProcessInstanceOperationRepresentation(processInstance, processDefinition, processDefinition.isGraphicalNotationDefined(), userRep,processInstanceId);
...
//        ProcessInstanceOperation proLog = new ProcessInstanceOperation();
//        ProcessInstance proInstance = runtimeService.createProcessInstanceQuery().processInstanceId(startRequest.getProcessDefinitionId()).singleResult();
//        if(proInstance!=null){
//            proLog.setPlanID(proInstance.getProcessDefinitionId());
//            proLog.setInstanceID(proInstance.getProcessInstanceId());
//            proLog.setPlan_start_time(proInstance.getStartTime());
//        }else{
//            proLog=null;
//        }
//        assert proLog != null;
